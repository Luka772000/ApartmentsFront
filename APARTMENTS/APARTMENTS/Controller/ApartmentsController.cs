...
{   
    ...
    public class ApartmentsController : ControllerBase
    {
        ...
        public ApartmentsController(Context context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Apartments.Include(ap => ap.Adress).Include(co => co.contracts).ThenInclude(u => u.User).ToListAsync();
        }
        ...
        {
            var adress = await _context.Adresses.FindAsync(apartment.AdressId);
            if (adress == null)
                return NotFound();
